...
import (
	...
	"github.com/asynccnu/be-calendar/domain" // 替换为calendar的domain路径
	"github.com/asynccnu/be-calendar/pkg/errorx"
	"github.com/asynccnu/be-calendar/pkg/logger"       // 替换为calendar的logger路径
	"github.com/asynccnu/be-calendar/repository/cache" // 替换为calendar的cache路径
	"github.com/asynccnu/be-calendar/repository/dao"   // 替换为calendar的dao路径
